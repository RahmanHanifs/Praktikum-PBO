 ...
 * @author LENOVO
 */
public class ProyekGui2 extends javax.swing.JFrame {
    DefaultListModel<String> dlm;
    
    /**
     * Creates new form ProyekGui2
     */
    public ProyekGui2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProyekGui2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProyekGui2().setVisible(true);
            }
        });
    }
